 ...
 *
 */
package net.mcreator.edgesoflight;
...
@Mod("edges_of_light")
public class EdgesOfLightMod {
	public static final Logger LOGGER = LogManager.getLogger(EdgesOfLightMod.class);
	public static final String MODID = "edges_of_light";
	private static final String PROTOCOL_VERSION = "1";
	public static final SimpleChannel PACKET_HANDLER = NetworkRegistry.newSimpleChannel(new ResourceLocation(MODID, MODID), () -> PROTOCOL_VERSION,
			PROTOCOL_VERSION::equals, PROTOCOL_VERSION::equals);
	private static int messageID = 0;

	public EdgesOfLightMod() {
